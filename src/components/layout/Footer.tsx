...
export function Footer({ overlay }: { overlay?: boolean }) {
  return (
    <footer
      className={`font-mono text-[11px] tracking-[0.03em] text-zinc-500 dark:text-zinc-500 ${
        overlay
          ? 'absolute inset-x-6 bottom-0 z-10 py-6 sm:inset-x-8 sm:py-8 lg:inset-x-12'
